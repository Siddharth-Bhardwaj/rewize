...
const ByteBites = () => {
  const categoryIds = ["77b127ce-0360-4ee8-bc96-f5e76155d132"];
        ...
        <div className="flex w-full flex-col gap-y-8 px-12 lg:w-1/3 lg:px-20">
          <div className="flex items-start gap-x-8">
            <Image
              ...
              draggable={false}
              className="h-20 w-20"
              src="/chicken-potato.webp"
            />

            <div className="flex flex-col">
              <span>Chicken and Sweet Potatoes</span>
