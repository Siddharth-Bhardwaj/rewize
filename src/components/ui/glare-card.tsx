...
export const GlareCard = ({
  ...
  return (
    <div
      ...
      className="relative isolate aspect-[210/331.7] w-[210px] transition-transform delay-[var(--delay)] duration-[var(--duration)] ease-[var(--easing)] will-change-transform [contain:layout_style] [perspective:600px]"
      ref={refElement}
      onPointerMove={(event) => {
